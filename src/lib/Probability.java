...
public class Probability {
	...
	public static BigInteger bigCombination(long n, long k) {
		return bigPermutation(n, k).divide(Numbers.bigFactorial(k)); // combinations don't care about order, so factor it out
	}
	...
	public static BigInteger bigPermutation(long n, long k) {
		return Numbers.bigFactorial(n).divide(Numbers.bigFactorial(n - k));
	}
